    ...
    (
        ...
        FROM
            (
                ...
                And
--                 ih.PIY_INSUTYPE
                        sh.gsh_settlementdate BETWEEN  '01-Jan-2000' AND '31-Mar-2019'
                    AND
                        b.vchdate BETWEEN  '01-Jan-2000' AND '31-Mar-2019'
                    AND
                        h.gdh_commdate BETWEEN '01-jan-2000' AND '31-Mar-2019'
                    AND
                        ih.gih_intimationdate BETWEEN '01-Apr-2017' AND '31-Mar-2019'
            ) pd1
    )
GROUP BY
    pdp_desc,
